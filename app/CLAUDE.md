...
### 레이아웃 구조 (2차 Dynamic Layout)

```
QHD (2560px+):
[사이드바 80px] - [Task 패널 0~360px] - [타이머 중앙] - [우측 위젯 570px] - [광고 200px]

xl (1280px~2560px):
[사이드바 80px] - [Task 패널 0~360px] - [타이머 중앙] - [우측 위젯 570px]

모바일 (xl 미만):
[타이머 중앙] → [BGM/캘린더 하단] (사이드바 숨김, Task 하단 시트)
```

**참고**: 기존 좌측 대시보드(dashboard-left)는 /stats 페이지로 이동됨
